...
FROM USER_CONSTRAINTS C1
JOIN USER_CONS_COLUMNS C2 USING
(CONSTRAINT_NAME)
WHERE C1.TABLE_NAME = 'DEPT_COPY';
...
ALTER TABLE DEPT_COPY 
DROP CONSTRAINT SYS_C007455;

ALTER TABLE DEPT_COPY 
DROP CONSTRAINT SYS_C007459;

-- MODIFY 이용해서 NOT NULL 제거하기
ALTER TABLE DEPT_COPY
MODIFY LOCATION_ID CONSTRAINT SYS_C007456 NULL; 

/* 제약 조건은 수정이 안되기 때문에 삭제 후 다시 생성하는 형식으로 수정을 진행 */
